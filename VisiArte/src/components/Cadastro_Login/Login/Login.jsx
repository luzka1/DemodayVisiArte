    ...
    return(
        ...
        <div className={Styles.DivMeio}>
            ...
            <div className={Styles.Logo}>
                ...
                <span className={Styles.VisiArte}>VisiArte</span> 
            </div>
            ...
            <div className={Styles.MeioBaixo}>
                ...
                <div className={Styles.Iniciando}>
                    <input type="text" placeholder="Nome de Usuário" className={Styles.Nome} />

                    <input type="text" placeholder="Senha" className={Styles.Senha}/>
                </div>

                <div className={Styles.Manter}>
                    <input type="checkbox" name="ManterLogin" className={Styles.Login} />
                    <label for="ManterLogin">Manter conectado</label>
                </div>

                <Link to ="/feed" className={Styles.Acessar}>Acessar </Link>

                <Link to ="/feed" className={Styles.EsqSenha}>Esqueceu a senha?</Link>

                <Link to ="/feed" className={Styles.CrieConta}>Criar conta</Link>
