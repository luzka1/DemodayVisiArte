    ...
    return (
        <>
            ...
            <div className={styles.bottom}>
                <p className={styles.contato}>contato@contato.com</p>
                <p>PROA 2022 &#xa9; todos os direitos reservados</p>
            </div>
